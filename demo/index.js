  ...
  var component = (
    <Menu effect={effect} method={method} position={pos}>
      ...
      <ChildButton
        ...
        href="https://github.com/d-bearstar/react-material-floating-button/" />
      <ChildButton
        icon="ion-social-octocat"
        label="Follow me on Github"
        href="https://github.com/d-bearstar" />
      <ChildButton
        icon="ion-social-twitter"
        label="Share on Twitter"
        href="http://twitter.com/share?text=Amazing Google Inbox style material floating menu as a React component!&hashtags=material,menu,reactjs,react,component" />
    </Menu>
  );
